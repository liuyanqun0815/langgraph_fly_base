...
class WeaviateVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Datasets, attributes: list, embeddings: Embeddings) -> WeaviateVector:
        if dataset.index_struct_dict:
            class_prefix: str = dataset.index_struct_dict['vector_store']['class_prefix']
            collection_name = class_prefix
        else:
            dataset_id = dataset.id
            collection_name = Datasets.gen_collection_name_by_id(dataset_id)
